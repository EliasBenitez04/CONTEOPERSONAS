...
def main():
    ...
    session_base_out = int(
        today_totals["OUT"]
    )

    print(
        "[DB] Historial del dia conservado:"
    )

    print(
        f"     Entradas: {session_base_in}"
    )

    print(
        f"     Salidas:  {session_base_out}"
    )

    print(
        "[SESION] Contadores iniciados en 0 / 0."
    )
            ...
            if key == ord("c"):
                ...
                if direction_changed:
                    print(
                        ...
                        "en vista, conteo y registros de hoy."
                    )
                else:
                    print(
