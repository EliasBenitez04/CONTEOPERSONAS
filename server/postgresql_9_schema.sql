...
CREATE INDEX idx_cameras_branch_id
    ON cameras(branch_id);

CREATE INDEX idx_count_events_event_uuid
    ON count_events(event_uuid);

CREATE INDEX idx_count_events_branch_id
    ON count_events(branch_id);

CREATE INDEX idx_count_events_camera_id
    ON count_events(camera_id);

CREATE INDEX idx_count_events_event_type
    ON count_events(event_type);

CREATE INDEX idx_count_events_occurred_at
    ON count_events(occurred_at);
